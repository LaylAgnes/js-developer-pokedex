...
export const legendaryPokemons = [
  ...
  "palkia", "heatran", "regigigas", "giratina", "cobalion", "terrakion",
  "virizion", "tornadus", "thundurus", "reshiram", "zekrom", "landorus",
  "kyurem", "xerneas", "yveltal", "zygarde", "tapukoko", "tapulele",
  "tapubulu", "tapufini", "solgaleo", "lunala", "nihilego", "buzzwole",
  "pheromosa", "xurkitree", "celesteela", "kartana", "guzzlord", "necrozma",
  "kubfu", "urshifu", "regieleki", "regidrago", "glastrier", "spectrier",
  "calyrex"
];

export const mythicalPokemons = [
